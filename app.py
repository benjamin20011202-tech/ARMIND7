...
PRODUCT_LIST = [
    {"브랜드": "자민경", "제품명": "크레마카발로 클렌징오일 투 폼", "용량": "110ml*5개", "가격": 27000, "비고": ""},
    {"브랜드": "라더마", "제품명": "스킨사이언스 리커버리크림 프리미엄", "용량": "100ml", "가격": 14000, "비고": "2개 구매시 +1"},
    {"브랜드": "벨레닉", "제품명": "크림 프레스티지 에이지 퀸", "용량": "50ml", "가격": 12000, "비고": ""},
    {"브랜드": "리더스", "제품명": "프로 하이드리 아미노 슬리핑 마스크", "용량": "4ml*30개", "가격": 7900, "비고": ""},
    {"브랜드": "자민경", "제품명": "크레마카발로 링클 리듀싱 아이크림", "용량": "20ml*5개", "가격": 19040, "비고": ""},
    {"브랜드": "라보테", "제품명": "콜라겐 에센스 인 토너", "용량": "500ml", "가격": 9200, "비고": ""},
    {"브랜드": "비원츠", "제품명": "피토 콜라겐 아이세럼스틱", "용량": "15ml", "가격": 9000, "비고": ""},
    {"브랜드": "프리티스킨", "제품명": "토탈 솔루션 2X 파워 시네이크 링클 팩터", "용량": "12ml*3개", "가격": 26250, "비고": ""},
    {"브랜드": "에스미라클", "제품명": "타이거 스네일 크림", "용량": "50ml", "가격": 16030, "비고": "1+1"},
    {"브랜드": "라보테", "제품명": "에스테 RX 콜라겐 크림", "용량": "50ml", "가격": 29900, "비고": ""},
    {"브랜드": "프리티스킨", "제품명": "24K 골드 콜라겐 앰플", "용량": "50ml*3개", "가격": 22900, "비고": ""},
    {"브랜드": "누보바세", "제품명": "페이셜 모이스처 오일 폼 클렌저", "용량": "210ml", "가격": 13500, "비고": ""},
    {"브랜드": "W.피부연구소", "제품명": "펩타이드 크림", "용량": "50ml*2개", "가격": 22800, "비고": ""},
    {"브랜드": "자민경", "제품명": "크레마카발로 달팽이 클렌징 폼", "용량": "175ml*5개", "가격": 23200, "비고": ""},
    {"브랜드": "자민경", "제품명": "크레마카발로 에브리데이 수딩 크림", "용량": "300ml*5개", "가격": 19200, "비고": ""},
    {"브랜드": "프리티스킨", "제품명": "토탈 솔루션 24K 골드 스네일 클렌징 폼", "용량": "150ml*3개", "가격": 14300, "비고": ""},
    {"브랜드": "핑크원더", "제품명": "호호바 오일", "용량": "50ml", "가격": 38800, "비고": ""},
    {"브랜드": "W.피부연구소", "제품명": "시카플러스 재생크림 (튜브)", "용량": "50ml*2개", "가격": 14800, "비고": ""},
    {"브랜드": "W.피부연구소", "제품명": "트리플케어 선크림", "용량": "60g*2개", "가격": 7800, "비고": "SOLD OUT"},
    {"브랜드": "참존", "제품명": "황후지화 리본(S) 3종 세트", "용량": "세트", "가격": 32600, "비고": ""},
    {"브랜드": "쿠피", "제품명": "PDRN 연어 앰플", "용량": "30ml", "가격": 16740, "비고": ""},
    {"브랜드": "엘렌실라", "제품명": "에스카르고 안티링클 밤", "용량": "9g*3개", "가격": 21000, "비고": ""},
    {"브랜드": "듀이트리", "제품명": "어반 쉐이드 커버 앤 핏 선 쿠션", "용량": "14g", "가격": 10500, "비고": ""},
    ...
    {"브랜드": "폴메디슨", "제품명": "시그니처 바디워시 화이트머스크", "용량": "1077ml*2개", "가격": 15220, "비고": ""},
    ...
    {"브랜드": "리우젤", "제품명": "그루밍 토닉", "용량": "350ml", "가격": 17000, "비고": ""},
    ...
    {"브랜드": "일동제약", "제품명": "퍼스트랩 프로바이오틱 세럼", "용량": "30ml*3개", "가격": 35900, "비고": "5+1"},
    {"브랜드": "웰더마", "제품명": "시카 케어 세럼 & 롤러 세트", "용량": "세럼50ml+롤러", "가격": 29000, "비고": ""},
    ...
    {"브랜드": "라운드랩", "제품명": "자작나무 수분 선크림", "용량": "50ml*2개", "가격": 16500, "비고": ""},
    {"브랜드": "아이오페", "제품명": "UV 쉴드 선 프로텍터 XP", "용량": "60ml", "가격": 12140, "비고": ""},
    {"브랜드": "본에스티스", "제품명": "다이아몬드 리페어 퍼펙트 세트", "용량": "세럼+크림", "가격": 38500, "비고": ""},
    ...
    {"브랜드": "이니스프리", "제품명": "비자 씨드 클렌징 폼", "용량": "150g", "가격": 4500, "비고": ""},
    {"브랜드": "메디힐", "제품명": "캘러스 멀티 골드 리프팅 크림", "용량": "50ml", "가격": 7200, "비고": ""},
    {"브랜드": "SNP", "제품명": "골드 콜라겐 슬리핑 팩", "용량": "100ml", "가격": 5800, "비고": ""},
    {"브랜드": "참존", "제품명": "마유 크림 엑스트라 골든 컴플렉스", "용량": "70ml", "가격": 7000, "비고": ""},
    {"브랜드": "자민경", "제품명": "크레마카발로 에이지 어웨이 프리미엄 크림", "용량": "50ml", "가격": 8500, "비고": ""},
